...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="container-fluid text-center" >
        <br>
        <h2> Update data </h2>
        <p> Add new colleges to the database and preview the website.</p>
        <br>
 
        <br><br>
    <button class="btn" type="submit" style="padding:30px 100px; font-size:20px;"> <a href="addit.html"> ADD ENGINEERING COLLEGE </a></button>
    <button class="btn" type="submit" style="padding:30px 100px; font-size:20px;"> <a href="addcomps.html"> ADD ARTS COLLEGE </a></button>
    <button class="btn" type="submit" style="padding:30px 100px; font-size:20px;"> <a href="addmech.html"> ADD MEDICAL COLLEGE </a></button>
    <button class="btn" type="submit" style="padding:30px 100px; font-size:20px;"> <a href="addextc.html"> ADD BUSINESS COLLEGE </a></button>
    <button class="btn" type="submit" style="padding:30px 100px; font-size:20px;"> <a href="view.php"> PREVIEW WEBPAGE </a></button>
<br>
<br>    
</div>
<footer>
