...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="container-fluid text-center">
        <h1> Queries </h1>
        <h3>Responses from the contact us form</h3>
    <br>
<?php
...
echo "<table>"; 
echo "<tr><td>" . "Name of the Respondent" . "</td><td>" . "Email ID" . "</td><td>" ."Response"; 
while($row = mysqli_fetch_array($result)){   
echo "<tr><td>" . $row['fname'] . "</td><td>" . $row['email'] . "</td><td>". $row['comments'];  
}
