...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="container-fluid text-center">
        <h2> Welcome Admin! </h2>
        <img src="Pics/20.jpg" style="border-radius: 25px; width: 490px; height: 330px;">
        <br>
        <br>
        <p> The portal provides you with options to view and alter the colleges available and to handle the queries that we receive. </p>
